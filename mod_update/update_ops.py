...
class WM_OT_booltron_update_check(Operator):
    ...
    bl_idname = "wm.booltron_update_check"
    bl_options = {"INTERNAL"}
...
class WM_OT_booltron_update_download(Operator):
    bl_label = "Install Update"
    bl_description = "Download and install new version of the add-on"
    bl_idname = "wm.booltron_update_download"
    bl_options = {"INTERNAL"}
...
class WM_OT_booltron_update_whats_new(Operator):
    bl_label = "See What's New"
    bl_description = "Open release notes in web browser"
    bl_idname = "wm.booltron_update_whats_new"
    bl_options = {"INTERNAL"}
...
OP_IDNAME_CHECK = WM_OT_booltron_update_check.bl_idname
OP_IDNAME_DOWNLOAD = WM_OT_booltron_update_download.bl_idname
OP_IDNAME_WHATS_NEW = WM_OT_booltron_update_whats_new.bl_idname
