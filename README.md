...
1. Download [Booltron 2.8.0][v_latest].<sup>1</sup>
...
1. Загрузите [Booltron 2.8.0][v_latest].<sup>1</sup>
...
[v_latest]: https://github.com/mrachinskiy/booltron/releases/download/v2.8.0-blender2.93.0/booltron-2_8_0.zip
