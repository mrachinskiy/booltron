...
1. Download [Booltron 2.6.1][v_latest].<sup>1</sup>
...
1. Загрузите [Booltron 2.6.1][v_latest].<sup>1</sup>
...
[v_latest]: https://github.com/mrachinskiy/booltron/releases/download/v2.6.1-blender2.90.0/booltron-2_6_1.zip
